...
Не можна використовувати готові рішення, а також бібліотеки для переміщення об’єктів, а також chatgpt або інші AI рішення. Тільки чистий JS та СSS у разі потреби. Дизайн на ваш смак
